...
# scripts/collect_traffic.py
"""
Collects GitHub traffic data (views, unique visitors, clones) for all repositories
in an organization and stores it as CSV for historical tracking.
"""
...
def main():
    ...
    for repo in repos:
        ...
        # Collect popular paths and referrers
